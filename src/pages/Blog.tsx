...
type Category = 'All' | 'Career Advice' | 'AI & Tech' | 'Hiring' | 'Remote Work' | 'Salary & Benefits' | 'Leadership';
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 pb-20 md:pb-0">
        <PageHero
          title="JobBridge Insights"
          subtitle="Expert advice on careers, hiring, and the future of work"
          images={HERO_CAROUSELS.blog}
          imageAlt="Person reading career articles"
        />
        ...
        {featuredPost && (
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow grid md:grid-cols-2">
              <div>
                <img src={featuredPost.img || 'https://images.pexels.com/photos/7176027/pexels-photo-7176027.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&dpr=2'} alt={featuredPost.title} loading="eager" decoding="async" className="w-full h-full object-cover min-h-[250px]" />
              </div>
              <div className="p-8">
                ...
                <div className="flex flex-wrap items-center justify-between">
                  <div className="flex items-center space-x-4 text-sm text-blue-700 mb-4 sm:mb-0">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600">{featuredPost.date} • {featuredPost.readTime} min read</p>
                    </div>
                  </div>
                  <button
        ...
        <AnimatedSection direction="up">
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-children stagger-visible">
            {filteredPosts.map(post => (
              <Card3D
                ...
                strength={6}
              >
                <img src={post.img || 'https://images.pexels.com/photos/7176027/pexels-photo-7176027.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=2'} alt={post.title} loading="lazy" decoding="async" className="w-full h-44 object-cover" />
                  ...
                  <div className="border-t border-gray-200 pt-4 mb-4">
                    <div className="flex items-center space-x-3 text-sm text-gray-600 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500">{post.date} • {post.readTime} min</p>
                      </div>
                    </div>
                  </div>
                  <button
                    onClick={() => navigate(`/blog/${post.id}`)}
                    className="bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 rounded-lg font-semibold transition-colors w-full"
                  >
                    Read More
                  </button>
                </div>
        ...
        <section className="bg-blue-700 py-12 px-4 sm:px-6 lg:px-8 mt-12">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Subscribe to JobBridge Insights
            </h2>
            <p className="text-blue-100 mb-6">
              Get the latest articles on careers, hiring, and the future of work delivered to your inbox.
            </p>
