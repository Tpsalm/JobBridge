                ...
                <button
                  onClick={() =>
                    openModal('info', {
                      ...
                      content:
                        'This action is permanent and cannot be undone. All your data, applications, and profile information will be permanently deleted. Please contact jobbridgesupport@gmail.com (tap to email) if you need assistance.',
                    })
                  }
