...
export interface EmailPayload {
  type: 'welcome' | 'subscription' | 'application' | 'recruiter_notification' | 'payment' | 'payment_initiated' | 'application_status' | 'new_recruiter' | 'job_posted' | 'advert_created' | 'daily_digest' | 'sign_in' | 'sign_out' | 'profile_reminder' | 'message_alert';
  email: string;
  name?: string;
  jobTitle?: string;
  company?: string;
