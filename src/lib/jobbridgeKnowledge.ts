...
5. Click "Publish This Job" to post directly`,
  },
  {
    ...
    tags: ['ai', 'job-seeker'],
    pages: ['/ai-resume'],
    keywords: ['interview prep', 'mock interview', 'practice interview', 'interview questions', 'interview preparation', 'ai interview'],
    content: `AI Interview Preparation helps you practice for job interviews. You can get industry-specific questions, practice responses, and receive feedback.
This feature requires an active AI subscription (₦1,500/month or ₦15,000/year).
Access it from the AI Resume Studio page at /ai-resume.`,
  },
  {
...
You can search within each tab and browse jobs directly.`,
  },
  {
    ...
    pages: [],
    keywords: ['pwa', 'progressive web app', 'install app', 'mobile app', 'offline', 'install jobbridge'],
    content: `JobBridge is a Progressive Web App (PWA). You can install it on your device for a native app-like experience:
• Desktop: Click the install icon in the browser address bar
• Mobile: Use "Add to Home Screen" from the browser menu
• Benefits: Faster loading, offline access to cached content, push notifications`,
  },
];
